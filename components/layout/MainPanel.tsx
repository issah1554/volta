...
export default function MainPanel({ title, onClose, children }: MainPanelProps) {
    return (
        <div className="absolute left-0 right-0 top-0 z-1100 h-screen sm:left-0 sm:right-auto">
            <div
                className="w-full max-w-full sm:w-114 sm:max-w-[calc(100vw-40px)]  h-full
                 bg-white/80 pt-14 shadow-xl backdrop-blur-sm flex flex-col ">
                ...
                <div className="flex-1 overflow-y-auto text-sm text-main-700">
